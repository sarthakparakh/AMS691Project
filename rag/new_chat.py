...
def generate_response_from_llm(prompt: str, chat_groq: ChatGroq, vector_db: Qdrant) -> str:
    """
...
def save_response_to_json(response: str, student_profile_name: str):
    ...
    try:
        ...
        json_file_path = f"data\\response\\response_{student_profile_name}.json"
...
def main():
    ...
    document_path = 'data\student_profiles\AMS_691_Sarthak_Parakh_docs.pdf'
    ...
    user_prompt = """
        ...
        """
    print(user_prompt)
    response = generate_response_from_llm(user_prompt, chat_groq, vector_db)
